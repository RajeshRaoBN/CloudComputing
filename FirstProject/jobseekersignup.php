...
if(mysqli_num_rows($result)>=1) {
    ...
    echo '<div align="center"><a href="landing1.html">Click here for job seaker login</a></div>';
    echo '<div align="center"><a href="forgottenpassword.html">Click here to recover forgotten password</a></div>';
}
else {
    ...
    if(mysqli_num_rows($result)>=1) {
        ...
        echo '<div align="center"><a href="jobseekersignup.html">Click here to choose a new userid</a></div>';
    }
    else {
